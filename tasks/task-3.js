...
// become significantly larger. It would end up looking messy if we left it in
// the `ReactDOM.render()` method. Instead, let's pull it out and set it as the
// value of some variable.

// Somewhere between the import statements and the render method, declare a
// `animalFacts` constant, and set it's value to the JSX expression that is
// currently in the render method.

// Then, replace the JSX expression in the render method with the variable we
// just declared.

// Click Run to verify that nothing has changed.
